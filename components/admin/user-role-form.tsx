      ...
      <form action={formAction} className="flex flex-col gap-3">
        ...
        <div className="space-y-1">
          ...
          <select
            ...
            className="w-full block pl-3 pr-10 py-2.5 text-sm border border-gray-300 focus:outline-none focus:ring-2 focus:ring-[#FF6B35]/30 focus:border-[#FF6B35] rounded-lg bg-white cursor-pointer font-medium text-[#1E3A5F]"
          >
            {allRoles.map((role) => (
        ...
        <div className="space-y-2">
          ...
          <div className="flex flex-wrap gap-2">
            <label className={`inline-flex items-center gap-2 px-3 py-2 rounded-lg border transition-all cursor-pointer ${
              assignmentType === 'global'
                ? 'border-[#FF6B35] bg-[#FF6B35]/10 text-[#1E3A5F]'
              ...
              <input
                ...
                className="h-3.5 w-3.5 text-[#FF6B35] focus:ring-[#FF6B35]/20 cursor-pointer"
              />
          ...
          {assignmentType === 'branch' && (
            <div className="pt-1">
              <label htmlFor={`location-${userId}`} className="sr-only">Branch location</label>
              <select
                id={`location-${userId}`}
                name="location_id"
