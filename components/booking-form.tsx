                    ...
                    return (
                      <button
                        ...
                        className={`relative px-2.5 py-2.5 sm:px-3 sm:py-3 md:px-4 md:py-4 rounded-lg sm:rounded-xl border-2 transition-all duration-200 transform active:scale-95 min-h-[70px] sm:min-h-[80px] md:min-h-[90px] flex flex-col items-center justify-center ${
                          isSelected
                            ? 'bg-linear-to-br from-[#FF6B35] to-[#FF8C61] text-white border-[#FF6B35] shadow-xl shadow-[#FF6B35]/40 scale-105 ring-2 sm:ring-4 ring-[#FF6B35]/20'
                            : isAvailable && price > 0
                            ? 'bg-white text-[#1E3A5F] border-[#1E3A5F]/30 hover:border-[#FF6B35] hover:bg-linear-to-br hover:from-[#FF6B35]/10 hover:to-[#1E3A5F]/10 hover:shadow-lg active:scale-95'
